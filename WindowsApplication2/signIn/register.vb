            ...
            If txt_password.Text = txt_repass.Text Then
                ...
                Try
                    ...
                    If s = "" Then
                        ...
                        If coucc <> "" Then
                            cmd = New SqlCommand("insert into useraccount (id,username,password,email,cash)values('" + geno() + "','" + txt_username.Text + "','" + txt_password.Text + "','" + txt_email.Text + "','" + cash.tostring + "')", con)
                            cmd.ExecuteNonQuery()
                        Else
                            cmd = New SqlCommand("insert into useraccount (id,username,password,email,cash)values('" + id + "','" + txt_username.Text + "','" + txt_password.Text + "','" + txt_email.Text + "','" + cash.tostring + "')", con)
                            cmd.ExecuteNonQuery()
